# -*- coding: utf-8 -*-
from schemaorgschemas.Thing import potentialActionProp, nameProp, urlProp, imageProp, sameAsProp, mainEntityOfPageProp, additionalTypeProp, alternateNameProp, descriptionProp
...
class RoofingContractorSchema(SchemaObject):

    """Schema Mixin for RoofingContractor
    Usage: place after django model in class definition, schema will return the schema.org url for the object
    A roofing contractor.
    """

    def __init__(self):
        self.schema = 'RoofingContractor'
